...
- [Django](https://github.com/django) - [php-fpm](https://hub.docker.com/_/php?tab=tags&page=1&name=fpm)
...
```
git clone https://github.com/damalis/full-stack-apache2-django-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-apache2-django-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
...
The containers are now built and running. You should be able to access the Django installation with the configured IP in the browser address. `https://example.com`.
...
You should see the "Hello, world!" page in your browser. If not, please check if your PHP installation satisfies Django's requirements.
...
##### # backup exclude django, backups folders in ${DIRECTORY_PATH}
